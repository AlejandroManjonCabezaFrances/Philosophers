...
/*   Updated: 2023/11/29 15:30:01 by amanjon-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_philo
{
	...
	// pthread_mutex_t		*print_mutex;	// Al comentar estos mutex, funcion
	// pthread_mutex_t		*lock;			// ft_usleep se queda en bucle infinito
	t_data				*data;
}	t_philo;
